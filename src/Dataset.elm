...
libraryState =
    Dict.fromList
        ...
        , ( "Ночью 16 января; Идеал; Подумай дважды", AlreadyTaken )
        ...
        , ( "Теория игр", Available )
        , ( "Как писать нон-фикшн", Available )
        , ( "Черный лебедь. Под знаком непредсказуемости", Available )
--        , ( "GraphQL: язык запросов для современных веб-приложений", AlreadyTaken )
        , ( "PostgreSQL. Основы языка SQL", Available )
