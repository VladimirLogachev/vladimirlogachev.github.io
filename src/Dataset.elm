...
type alias Item =
    { name : String, description : String, links : List Link, imgFileName : Maybe String, team : List TeamMate }
...
type alias Book =
    { author : String, title : String, skills : Skill, url : String }


type alias TeamMate =
    { name : String, githubUserId : Int, url : String }
...
musicianData =
    { bookshelf =
        [ Book "Aspen Pittman"
            ...
            AMP
            "https://www.halleonard.com/product/viewproduct.action?subsiteid=7&itemid=331091"
        , Book "Donald Brosnac"
